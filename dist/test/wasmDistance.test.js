...
describe('JS vs WASM distance equivalence', function () {
    test('euclidean: JS and WASM produce identical values', function () {
        ...
        var euclidMock = jest.spyOn(wasmBridge, 'euclideanWasm').mockImplementation(function () { return jsResult; });
        var isWasmAvailableMock = jest.spyOn(wasmBridge, 'isWasmAvailable').mockImplementation(function () { return true; });
    ...
    test('cosine: JS and WASM produce identical values', function () {
        ...
        var cosineMock = jest.spyOn(wasmBridge, 'cosineWasm').mockImplementation(function () { return jsResult; });
        var isWasmAvailableMock = jest.spyOn(wasmBridge, 'isWasmAvailable').mockImplementation(function () { return true; });
