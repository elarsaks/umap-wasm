...
function initWasm() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (wasmReady)
                return [2, wasmReady];
            wasmReady = Promise.resolve().then(function () { return __importStar(__webpack_require__(458)); }).then(function (mod) {
                wasmModule = mod;
                return mod;
            })
                .catch(function (err) {
...
var UMAP = (function () {
    ...
    UMAP.prototype.makeSearchFns = function () {
        ...
        var distanceWrapper = function (a, b) {
            if (_this.useWasmDistance && wasmBridge.isWasmAvailable()) {
...
describe('useWasmDistance toggle', function () {
    ...
    test('delegates to wasm when useWasmDistance is true', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            euclidMock = jest.spyOn(wasmBridge, 'euclideanWasm').mockImplementation(function () { return Math.sqrt(27); });
