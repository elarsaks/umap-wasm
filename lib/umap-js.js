...
var utils = __importStar(__webpack_require__(185));
...
var heap = __importStar(__webpack_require__(24));
var matrix = __importStar(__webpack_require__(499));
var tree = __importStar(__webpack_require__(450));
var utils = __importStar(__webpack_require__(185));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wasmReady = (function () { return __awaiter(_this, void 0, void 0, function () {
                var mod, lastError, maybeRequire, pathModule, fsModule, candidates, candidates_1, candidates_1_1, candidate, e_1, err_1;
                var e_2, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            lastError = null;
                            try {
                                maybeRequire = eval("typeof __non_webpack_require__ !== 'undefined' ? __non_webpack_require__ : (typeof require !== 'undefined' ? require : undefined)");
                                if (maybeRequire) {
                                    try {
                                        pathModule = maybeRequire('path');
                                        fsModule = maybeRequire('fs');
                                        candidates = [
                                            pathModule.resolve(process.cwd(), 'wasm/pkg/umap_wasm_core.js'),
                                            pathModule.resolve(__webpack_dirname__, '../wasm/pkg/umap_wasm_core.js'),
                                            pathModule.resolve(__webpack_dirname__, '../../wasm/pkg/umap_wasm_core.js'),
                                            pathModule.resolve(__webpack_dirname__, '../../../wasm/pkg/umap_wasm_core.js'),
                                        ];
                                        try {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4, Promise.resolve().then(function () { return __importStar(__webpack_require__(900)); })];
                        case 2:
                            mod = _b.sent();
                            wasmModule = mod;
                            return [2, mod];
                        case 3:
                            ...
                            lastError = e_1;
                            return [3, 4];
                        case 4: throw lastError || new Error('Could not load WASM module');
                        case 5:
                            err_1 = _b.sent();
                            wasmReady = null;
                            wasmModule = null;
...
var heap = __importStar(__webpack_require__(24));
var matrix = __importStar(__webpack_require__(499));
var nnDescent = __importStar(__webpack_require__(47));
var tree = __importStar(__webpack_require__(450));
var utils = __importStar(__webpack_require__(185));
var ml_levenberg_marquardt_1 = __importDefault(__webpack_require__(527));
var wasmBridge = __importStar(__webpack_require__(103));
...
var utils = __importStar(__webpack_require__(185));
var wasmBridge_1 = __webpack_require__(103);
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ levenbergMarquardt)
});
...
module.exports = require("../wasm/pkg/umap_wasm_core.js");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UMAP = void 0;
var umap_1 = __webpack_require__(329);
